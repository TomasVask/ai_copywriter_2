...
export function ChatMessage({
  ...
  return (
    <div className="flex justify-start relative">
      <div className="p-3 rounded-lg text-sm max-w-[95%] bg-gray-100">
        {/* Error state */}
        {hasError && (
        ...
        {modelResponse?.generatedContent && !hasError && (
          <div className="mt-3">
            <div className="font-medium text-xs text-gray-500 mb-1">GENERATED CONTENT</div>
            <div>
              {modelResponse?.generatedContent}
            </div>
          </div>
        )}
      </div>
